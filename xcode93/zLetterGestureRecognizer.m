...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    self.firstTap = [touches.anyObject locationInView:self.view]; //The first tap location will be set here in touches began.
}
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    UIView *superView = self.view;     //This allows us to get the points from the same coordinate system of the superview.
